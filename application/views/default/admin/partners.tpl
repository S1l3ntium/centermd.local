        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark text-left">Партнеры</h1>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="content">
                            ...
                            <div class="card mb-5 card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <button type="button" class="btn btn-block btn-outline-primary"
                                            ...
                                            data-target="#add-partner">Добавить партнера
                                    </button>
                                    <table id="table-partners" class="table table-bordered table-striped">
                                        <thead>
                                        <tr>
                                            <th>Логотип</th>
                                            <th>Название</th>
                                        ...
                                        {foreach $partners as $partner}
                                            <tr>
                                                <td style="text-align: center">
                                                    <img src="/data/images/partners/original/{$partner->image}" alt="" style="max-width: 300px; border-radius: 10px; height: 100px; object-fit: contain">
                                                </td>
                                                <td>
                                                    {$partner->title}
                                                </td>
                                                ...
                                                <td>
                                                    <div class="buttons-list">
                                                        <div class="button-edit new-edit btn btn-sm btn-warning" title="Редактировать"
                                                             ...
                                                             data-target="#update-partner" onclick="getPartner(this);">
                                                            <i class="fal fa-edit"></i>
                                                        </div>
                                                        <div class="button-delate new-delate btn btn-sm btn-danger" title="Удалить"
                                                             data-id="{$partner->id}" onclick="delPartner(this);">
                ...
                <div class="modal fade" id="add-partner">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Добавить нового партнера</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form role="form" id="addPartner">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="titleInput">Логотип</label>
                            ...
                            <div class="modal-footer justify-content-flex-end">
                                <button type="button" class="btn btn-primary save-partner">Сохранить</button>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="modal fade" id="update-partner">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form role="form" id="updatePartner">
                            ...
                            <div class="modal-footer justify-content-flex-end">
                                <button type="button" class="btn btn-primary update-partner">Сохранить</button>
                            </div>
                        </div>
                    </div>
                </div>
